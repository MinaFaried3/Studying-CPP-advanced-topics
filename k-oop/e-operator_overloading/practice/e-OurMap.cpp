...
● We want implement our own map
<string, int>. Internal data structures is
and usage as on right
● [string] return corresponding string or
0 if not exist
● [int] return sorted vector of strings that
has this integer value
